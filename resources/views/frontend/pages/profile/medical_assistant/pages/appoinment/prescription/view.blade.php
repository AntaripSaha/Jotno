                                    ...
                                    <div class="card card-table mb-0">
                                        <div class="card-body prescription-topbar">
                                            <div class="col-md-12">
                                                <ul>
                                                    <li>
                                                        <a href="{{ route('medical.assistant.perscription.edit.page',$prescription->prescription_no) }}">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('medical.assistant.perscription.billing',$prescription->prescription_no) }}">
                                                    ...
                                                    <li>
                                                        <a
                                                            href="{{ route('medical.assistant.perscription.report.view',['prescription_id'=>$prescription->id , 'appoinment_id' =>$appoinment->appoinment_no]) }}">
                                                            <i class="fa fa-eye"></i>
                                                            View Report
                                                        </a>
                                                    </li>
                                                            ...
                                                            <div class="medicine">
                                                                ...
                                                                @else
                                                                    ...
                                                                    @foreach( unserialize($prescription_medicine->timing)[0] as $timing )
                                                                        <span>
                                                                            {{ $timing['value'] }} : {{ App\Models\AppoinmentModule\Timing::where("id",$timing['id'])->select("value")->first()->value }}
                                                                            @if( !$loop->last )
                                                                            ,
                                                                            @endif
                                                                        </span>
