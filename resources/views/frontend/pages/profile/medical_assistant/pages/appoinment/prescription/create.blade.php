                                ...
                                <div class="tab-pane active" id="today-appointments">
                                    <div class="card card-table mb-0">
                                        <div class="card-body">
                                                                    ...
                                                                    <div class="doctor-widget">
                                                                        <div class="doc-info-left">
                                                                            <div class="doctor-img">
                                                                                ...
                                                                                <img src="{{ asset('images/profile/patient/'.$appoinment->patient->image) }}" alt="">
                                                                                @else
                                                                                <img src="{{ asset('images/profile/user.png') }}" alt="">
                                                                                @endif
                                                                            </div>
                                                                            <div class="doc-info-cont">
                                                                                <h4 class="doc-name">{{ $appoinment->patient->name }}
                                                                                </h4>
                                                                                <p class="doc-speciality">{{ $appoinment->patient->patient_id }}</p>
                                                                                ...
                                                                                <div class="clinic-services">
                                                                                    <span>
                                                                                        DOB : {{ $appoinment->patient->date_of_birth }}
                                                                                    </span>
                                                                                    <span>
                                                                                        Blood Group : {{ $appoinment->patient->blood_group }}
                                                                                    </span>
                                                                                    <span>
                                                                                        Gender : {{ $appoinment->patient->gender }}
                                                                                    </span>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="doctor-widget">
                                                                        <div class="doc-info-left">
                                                                            ...
                                                                            <div class="doc-info-cont">
                                                                                <h4 class="doc-name">{{ $appoinment->doctor->name }}
                                                                                </h4>
                                            ...
                                            <form action="{{ route('medical.assistant.perscription.add',$appoinment->appoinment_no) }}" method="post" class="ajax-form">
                                                @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 col-12">
                                                        ...
                                                        <div class="test-type-item form-group">
                                                            ...
                                                            <select name="{{ $test_type->id }}_test_type_list_id[]" multiple required class="form-control select2">
                                                                @foreach( $test_type->test_type_list as $test_type_list )
                                                                <option value="{{ $test_type_list->id }}">
                                                                    {{ $test_type_list->name }}
                                                                </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-12 form-group">
                                                        ...
                                                        <textarea name="advice" required rows="3" class="form-control"></textarea>
                                                    </div>
                                                    <!-- advise end -->
