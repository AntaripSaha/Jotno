                                                            ...
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton_{{ $prescription->id }}">
                                                                        <a class="dropdown-item" href="{{ route('patient.perscription.view',$prescription->prescription_no) }}">
                                                                            <i class="fas fa-eye"></i>
                                                                            View
                                                                        </a>
                                                                        <a class="dropdown-item" href="{{ route('patient.perscription.report.add.form',$prescription->prescription_no) }}" >
                                                                            <i class="fa fa-plus-circle"></i>
                                                                            Add Report
                                                                        </a>
                                                                        <a class="dropdown-item" href="{{ route('patient.perscription.report.view',['prescription_id'=>$prescription->id , 'appoinment_id' =>$appoinment->appoinment_no]) }}" >
                                                                            <i class="fa fa-eye"></i>
                                                                            View Report
                                                                        </a>
