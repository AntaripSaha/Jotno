            ...
            <div class="col-md-7 col-lg-8 col-xl-9 rightSideSection">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        @include('frontend.pages.messages')
                    </div>
                                                    ...
                                                    <tbody>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <div>
                                                         ...
                                                         <td>
                                                            <a  href="{{ route('patient.perscription.report.edit.page',['prescription_report_id'=> $prescription_report->id , 'appoinment_no'=>$appoinment->appoinment_no ]) }}"  class="float-left">
                                                                <button class="btn btn-info"><i class="fa fa-edit"></i></button>
                                                            </a>
                                                                <form action="{{ route('prescription.delete',$prescription_report->id) }}" onsubmit="confirm('Sure to Delete Report?')" method="post" class="float-left ml-1">
                                                                    @csrf
