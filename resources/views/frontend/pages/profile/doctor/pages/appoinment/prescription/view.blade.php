                                        ...
                                        <div class="card-body prescription-topbar">
                                            <div class="col-md-12">
                                                <ul>
                                                    <li>
                                                        <a
                                                            href="{{ route('doctor.perscription.edit.page',$prescription->prescription_no) }}">
                                                    ...
                                                    <li>
                                                        <a
                                                            href="{{ route('doctor.perscription.billing',$prescription->prescription_no) }}">
                                                    ...
                                                    <li>
                                                        <a
                                                            href="{{ route('doctor.perscription.report.view',['prescription_id'=>$prescription->id , 'appoinment_id' =>$appoinment->appoinment_no]) }}">
                                                            <i class="fa fa-eye"></i>
                                                            View Report
                                                        </a>
                                                    </li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-6">
                                                        <div class="right-card">
                                                            ...
                                                            <p>
                                                                Time :
                                                                @foreach( auth('doctor')->user()->day as $day )
                                                                {{ substr($day->day->name,0,3) }}
                                                                @if( !$loop->last )
                                                                ,
                                                                @endif
                                                                @endforeach
                                                                {{ auth('doctor')->user()->in }} to
                                                                {{ auth('doctor')->user()->out }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <!-- right part end -->
