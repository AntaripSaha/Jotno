                                                            ...
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton_{{ $prescription->id }}">
                                                                        <a class="dropdown-item" href="{{ route('doctor.perscription.view',$prescription->prescription_no) }}">
                                                                            <i class="fas fa-eye"></i>
                                                                            View
                                                                        </a>
                                                                        <a class="dropdown-item" href="{{ route('doctor.perscription.edit.page',$prescription->prescription_no) }}" >
                                                                            <i class="far fa-clipboard"></i>
                                                                            Edit
                                                                        </a>
                                                                        <a class="dropdown-item" href="{{ route('doctor.perscription.report.view',['prescription_id'=>$prescription->id , 'appoinment_id' =>$appoinment->appoinment_no]) }}" >
                                                                            <i class="fa fa-eye"></i>
                                                                            View Report
                                                                        </a>
                                                                    </div>
