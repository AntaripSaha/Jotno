                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline table-responsive">
                        <div class="card-header text-right">
                            @if( can("add_medicine") )
                            <button type="button" data-content="{{ route('medicine.add.modal') }}" data-target="#myModal"
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped dataTable dtr-inline medicine-datatable"
                                id="datatable">
                                <thead>
                                    <tr>
                                        <th>ID</th>
