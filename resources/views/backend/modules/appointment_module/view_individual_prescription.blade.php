                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="appointment-tab">
                                        <div class="tab-content">
                                                    ...
                                                    <div class="card-body prescription-topbar">
                                                        <div class="col-md-12">
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="{{ route('appointment.perscription.billing',$prescription->prescription_no) }}">
                                                                ...
                                                                <li>
                                                                    <a
                                                                        href="{{ route('appointment.perscription.report',['prescription_id'=>$prescription->id , 'appoinment_id' =>$appoinment->appoinment_no]) }}">
                                                                        <i class="fas fa-file-invoice"></i>
                                                                        View Report
                                                                    </a>
                                                                </li>
                                            ...
                                            <div class="tab-pane active" id="today-appointments">
                                                <div class="card card-table mb-0">
                                                    <div class="card-body prescription-view-card pdf"
                                                        id="prescription-view-card">
                                                        ...
                                                        <div class="col-md-12 patient-information">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-3 col-3">
                                                                    <p>Patient ID:
                                                                        {{ $appoinment->patient->patient_id }}</p>
                                                                </div>
                                                                <!-- item end -->
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-5 col-5">
                                                                    <div class="left-card">
                                                                        ...
                                                                        $prescription_test )
                                                                        <ul class="test-type">
                                                                            <li>{{ $prescription_test->test_type->name }}
                                                                            </li>
                                                                            <ul class="test-type-list">
                                                                                @foreach(
                                                                                unserialize($prescription_test->test_type_list)
                                                                                as $test_type_list )
                                                                                <li>
                                                                ...
                                                                <div class="col-md-7 col-7">
                                                                    <div class="right-card">
                                                                        ...
                                                                        <div class="image">
                                                                            <img
                                                                                src="{{ asset('frontend/img/rx.png') }}">
                                                                        </div>
                                                                        <!-- image card end -->

                                                                        <!-- medicine card start -->
                                                                        @foreach( $prescription->prescription_medicine
                                                                        as $prescription_medicine )
                                                                        <div class="medicine">
                                                                            <h2>
                                                                            ...
                                                                            @foreach(
                                                                            unserialize($prescription_medicine->timing)[0]
                                                                            as $timing )
                                                                            <span>
                                                                                {{ $timing['value'] }} :
...
<div class="card-body row prescription-view-card print">
    ...
    <div class="col-md-12 patient-information">
        <div class="row">
            ...
            <!-- item start -->
            <div class="col-md-3">
                <p>Patient ID: {{ $appoinment->patient->patient_id }}</p>
            </div>
            <!-- item end -->
