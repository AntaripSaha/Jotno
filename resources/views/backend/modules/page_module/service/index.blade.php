                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline table-responsive">
                        <div class="card-header text-right">
                            ...
                            @if( can("service") )
                            <button type="button" data-content="{{ route('service.add.modal') }}" data-target="#largeModal"
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped dataTable dtr-inline service-datatable"
                                id="datatable">
                                <thead>
                                    <tr>
                                        <th>Position</th>
